...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPC15Antenas } = require('../../../helpers/california/arregloTagsAireacion');
    ...
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            ...
            rl.on('line', (line) => {
                ...
                if (obj.Message === 'NotifyReadTag') {
                    const arreglo = obj.Params.Tags;
                    dataCache.PC15Antenas = [];
                    arreglo.forEach((ex, i) => {
                        obje[ex.Name.slice(5)] = ex.Value;     
                    });
                    dataCache.PC15Antenas.push(obje)
                    obje = {}
                    completedFuntions++
                    checkAllFuntionsComplete()
                }
...
const handleSubscriptionPC15 = (ws, message) => {
    if (message.toString() === 'subscribePC15'){
    ...
    } else if (message.toString() === 'unsubscribePC15'){
...
module.exports = { handleSubscriptionPC15 }
