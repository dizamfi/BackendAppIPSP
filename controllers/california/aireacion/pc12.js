...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPC12Antenas } = require('../../../helpers/california/arregloTagsAireacion');
    ...
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            ...
            rl.on('line', (line) => {
                ...
                if (obj.Message === 'NotifyReadTag') {
                    const arreglo = obj.Params.Tags;
                    dataCache.PC12Antenas = [];
                    arreglo.forEach((ex, i) => {
                        obje[ex.Name.slice(5)] = ex.Value;     
                    });
                    dataCache.PC12Antenas.push(obje)
                    obje = {}
                    completedFuntions++
                    checkAllFuntionsComplete()
                }
...
const handleSubscriptionPC12 = (ws, message) => {
    if (message.toString() === 'subscribePC12'){
    ...
    } else if (message.toString() === 'unsubscribePC12'){
...
module.exports = { handleSubscriptionPC12 }
