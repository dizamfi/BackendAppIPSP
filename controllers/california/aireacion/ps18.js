...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS18Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS18 = (ws, message) => {
    if (message.toString() === 'subscribePS18'){
    ...
    } else if (message.toString() === 'unsubscribePS18'){
