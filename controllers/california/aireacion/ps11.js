...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS11Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS11 = (ws, message) => {
    if (message.toString() === 'subscribePS11'){
    ...
    } else if (message.toString() === 'unsubscribePS11'){
