...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS13Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS13 = (ws, message) => {
    if (message.toString() === 'subscribePS13'){
    ...
    } else if (message.toString() === 'unsubscribePS13'){
