...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS17Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS17 = (ws, message) => {
    if (message.toString() === 'subscribePS17'){
    ...
    } else if (message.toString() === 'unsubscribePS17'){
