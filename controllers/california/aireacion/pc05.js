...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPC05Antenas } = require('../../../helpers/california/arregloTagsAireacion');
    ...
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            ...
            rl.on('line', (line) => {
                ...
                if (obj.Message === 'NotifyReadTag') {
                    const arreglo = obj.Params.Tags;
                    dataCache.PC05Antenas = [];
                    arreglo.forEach((ex, i) => {
                        obje[ex.Name.slice(5)] = ex.Value;     
                    });
                    dataCache.PC05Antenas.push(obje)
                    obje = {}
                    completedFuntions++
                    checkAllFuntionsComplete()
                }
...
const handleSubscriptionPC05 = (ws, message) => {
    if (message.toString() === 'subscribePC05'){
    ...
    } else if (message.toString() === 'unsubscribePC05'){
...
module.exports = { handleSubscriptionPC05 }
