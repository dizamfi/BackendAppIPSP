...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS20Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS20 = (ws, message) => {
    if (message.toString() === 'subscribePS20'){
    ...
    } else if (message.toString() === 'unsubscribePS20'){
