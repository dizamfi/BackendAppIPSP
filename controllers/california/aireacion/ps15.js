...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS15Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS15 = (ws, message) => {
    if (message.toString() === 'subscribePS15'){
    ...
    } else if (message.toString() === 'unsubscribePS15'){
