...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS16Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS16 = (ws, message) => {
    if (message.toString() === 'subscribePS16'){
    ...
    } else if (message.toString() === 'unsubscribePS16'){
