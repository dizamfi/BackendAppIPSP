...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPC09Antenas } = require('../../../helpers/california/arregloTagsAireacion');
    ...
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            ...
            rl.on('line', (line) => {
                ...
                if (obj.Message === 'NotifyReadTag') {
                    const arreglo = obj.Params.Tags;
                    dataCache.PC09Antenas = [];
                    arreglo.forEach((ex, i) => {
                        obje[ex.Name.slice(5)] = ex.Value;     
                    });
                    dataCache.PC09Antenas.push(obje)
                    obje = {}
                    completedFuntions++
                    checkAllFuntionsComplete()
                }
...
const handleSubscriptionPC09 = (ws, message) => {
    if (message.toString() === 'subscribePC09'){
    ...
    } else if (message.toString() === 'unsubscribePC09'){
...
module.exports = { handleSubscriptionPC09 }
