...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPC17Antenas } = require('../../../helpers/california/arregloTagsAireacion');
    ...
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            ...
            rl.on('line', (line) => {
                ...
                if (obj.Message === 'NotifyReadTag') {
                    const arreglo = obj.Params.Tags;
                    dataCache.PC17Antenas = [];
                    arreglo.forEach((ex, i) => {
                        obje[ex.Name.slice(5)] = ex.Value;     
                    });
                    dataCache.PC17Antenas.push(obje)
                    obje = {}
                    completedFuntions++
                    checkAllFuntionsComplete()
                }
...
const handleSubscriptionPC17 = (ws, message) => {
    if (message.toString() === 'subscribePC17'){
    ...
    } else if (message.toString() === 'unsubscribePC17'){
...
module.exports = { handleSubscriptionPC17 }
