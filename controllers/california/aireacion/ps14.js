...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS14Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS14 = (ws, message) => {
    if (message.toString() === 'subscribePS14'){
    ...
    } else if (message.toString() === 'unsubscribePS14'){
