...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS08Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS08 = (ws, message) => {
    if (message.toString() === 'subscribePS08'){
    ...
    } else if (message.toString() === 'unsubscribePS08'){
