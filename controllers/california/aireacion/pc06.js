...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPC06Antenas } = require('../../../helpers/california/arregloTagsAireacion');
    ...
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            ...
            rl.on('line', (line) => {
                ...
                if (obj.Message === 'NotifyReadTag') {
                    const arreglo = obj.Params.Tags;
                    dataCache.PC06Antenas = [];
                    arreglo.forEach((ex, i) => {
                        obje[ex.Name.slice(5)] = ex.Value;     
                    });
                    dataCache.PC06Antenas.push(obje)
                    obje = {}
                    completedFuntions++
                    checkAllFuntionsComplete()
                }
...
const handleSubscriptionPC06 = (ws, message) => {
    if (message.toString() === 'subscribePC06'){
    ...
    } else if (message.toString() === 'unsubscribePC06'){
...
module.exports = { handleSubscriptionPC06 }
