...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPC13Antenas } = require('../../../helpers/california/arregloTagsAireacion');
    ...
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            ...
            rl.on('line', (line) => {
                ...
                if (obj.Message === 'NotifyReadTag') {
                    const arreglo = obj.Params.Tags;
                    dataCache.PC13Antenas = [];
                    arreglo.forEach((ex, i) => {
                        obje[ex.Name.slice(5)] = ex.Value;     
                    });
                    dataCache.PC13Antenas.push(obje)
                    obje = {}
                    completedFuntions++
                    checkAllFuntionsComplete()
                }
...
const handleSubscriptionPC13 = (ws, message) => {
    if (message.toString() === 'subscribePC13'){
    ...
    } else if (message.toString() === 'unsubscribePC13'){
...
module.exports = { handleSubscriptionPC13 }
