...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPC02Antenas } = require('../../../helpers/california/arregloTagsAireacion');
    ...
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            ...
            rl.on('line', (line) => {
                ...
                if (obj.Message === 'NotifyReadTag') {
                    const arreglo = obj.Params.Tags;
                    dataCache.PC02Antenas = [];
                    arreglo.forEach((ex, i) => {
                        obje[ex.Name.slice(5)] = ex.Value;     
                    });
                    dataCache.PC02Antenas.push(obje)
                    obje = {}
                    completedFuntions++
                    checkAllFuntionsComplete()
                }
...
const handleSubscriptionPC02 = (ws, message) => {
    if (message.toString() === 'subscribePC02'){
    ...
    } else if (message.toString() === 'unsubscribePC02'){
...
module.exports = { handleSubscriptionPC02 }
