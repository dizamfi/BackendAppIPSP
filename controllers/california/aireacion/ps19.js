...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS19Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS19 = (ws, message) => {
    if (message.toString() === 'subscribePS19'){
    ...
    } else if (message.toString() === 'unsubscribePS19'){
