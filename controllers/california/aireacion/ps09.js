...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS09Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS09 = (ws, message) => {
    if (message.toString() === 'subscribePS09'){
    ...
    } else if (message.toString() === 'unsubscribePS09'){
