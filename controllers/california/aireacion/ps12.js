...
const { generarTags, generarTagsTA, generarTagsTCP, arregloTagsPS12Antenas } = require('../../../helpers/california/arregloTagsAireacion');
...
const handleSubscriptionPS12 = (ws, message) => {
    if (message.toString() === 'subscribePS12'){
    ...
    } else if (message.toString() === 'unsubscribePS12'){
